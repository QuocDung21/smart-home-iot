...
const failCurrentJson = () => {
  ...
  let imgUrl =
    "https://i.pinimg.com/originals/b1/9b/7e/b19b7e48f4d0376da0c3fc94727a68ee.jpg";
  return {
    messages: [
      { text: messtext },
      {
...
const getCurrentTemp = (data) => {
  ...
  let messtext2 = "👌😊";
  let imgUrl =
    "https://i.kym-cdn.com/photos/images/original/000/967/202/eb1.jpg";
  if (t > 34) {
    ...
    messtext2 = "so cold..";
    imgUrl =
      "https://cdn1.hoanghamobile.com/tin-tuc/wp-content/uploads/2018/01/winter-meme-generator-59d89e9f997fe.jpg";
  }
